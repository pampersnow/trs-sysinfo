	...
	<div id="content">
		<div class="container">
			<div class="row">
				...
				<div class="span9">
					<h1 class="page-title">
						<i class="icon-home"></i>热点文章
					</h1>
					<div class="widget widget-table" style="height: 25px;">
						<div id="from1" style="float: left;">
							<form action="${pageContext.request.contextPath }/sys/2042/doByTimeRdwz.html" method="post">
								...
								<nav class="navbar navbar-default" role="navigation">
									<div class="dropdown" style="height: 20px;">
										...
										<button type="button" class="btn btn-primary dropdown-toggle"
											data-toggle="dropdown" style="margin: auto;">前10篇</button>
										<div class="dropdown-menu"
											style="min-width: 100%; font-size: 15px;">
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doTodayRdwzDESC.html">今天</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doYesterdayRdwzDESC.html">昨天</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doWithinThreeDaysRdwzDESC.html">最近3天</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doWithinSevenDaysRdwzDESC.html">最近7天</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doWithinThisMonthRdwzDESC.html">本月</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/dordwz.html">所有</a>
										</div>
									</div>
								</nav>
							</div>
							<div style="float: right;">
								<nav class="navbar navbar-default" role="navigation">
									<div class="dropdown" style="height: 20px;">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<button type="button" class="btn btn-primary dropdown-toggle"
											data-toggle="dropdown" style="margin: auto;">后10篇</button>
										<div class="dropdown-menu"
											style="min-width: 100%; font-size: 15px;">
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doTodayRdwzASC.html">今天</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doYesterdayRdwzASC.html">昨天</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doWithinThreeDaysRdwzASC.html">最近3天</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doWithinSevenDaysRdwzASC.html">最近7天</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doWithinThisMonthRdwzASC.html">本月</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath }/sys/2042/doRdlmASC.html">所有</a>
										</div>
									</div>
								</nav>
							</div>
...
<!-- 						<div class="widget-header">
						...
						<div class="widget-content">
							<table class="table table-striped table-bordered">
								...
								<c:forEach items="${rdwzList}" var="li">
									<tr>
										<td>${li.siteid}</td>
										<td style="”word-wrap: break-word; word-break: break-all;">${li.articleid}</td>
										<td>${li.title}</td>
										<td><fmt:formatDate value="${li.writetime}"
